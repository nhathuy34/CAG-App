...
class StorageHelper {
  ...
  static const String _keyLastAvatarUrl = 'last_avatar_url';
  ...
  static Future<void> saveLastAvatarUrl(String url) async {
  await _storage.write(key: _keyLastAvatarUrl, value: url);
}

  static Future<String?> loadLastAvatarUrl() async {
    return await _storage.read(key: _keyLastAvatarUrl);
  }
