...
import 'package:CAG_App/src/features/GAMER/home/providers/nav_provider.dart'; // Thay bằng đường dẫn chính xác tới file chứa navIndexProvider của bạn
import '../widgets/detail_screen/fake_community_tab.dart';
import '../widgets/detail_screen/fake_cloud_save_tab.dart';


class FakeGameDetailScreen extends ConsumerStatefulWidget {
  final String bgUrl;
  final String title;
  ...
  @override
  // Đổi thành ConsumerState
  ConsumerState<FakeGameDetailScreen> createState() => _FakeGameDetailScreenState();
}

// Đổi thành ConsumerState
class _FakeGameDetailScreenState extends ConsumerState<FakeGameDetailScreen> {
                            ...
                            Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  // --- ĐÃ THÊM GESTURE DETECTOR CHỖ NÀY ---
                                  GestureDetector(
                                    onTap: () {
                                      // 1. Chuyển sang tab Cag Guide (Index 3 trong IndexedStack)
                                      ref.read(navIndexProvider.notifier).setIndex(3);
                                      // 2. Tắt màn hình Detail hiện tại để lùi về Home
