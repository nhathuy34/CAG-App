...
class _CommunityScreenState extends ConsumerState<CommunityScreen>
  ...
  Widget _buildBannerHeader(bool isLoggedIn) {
    // Use Responsive helper to detect sizes
    final bool isSmallScreen = Responsive.isSmall(context);
    final double titleSize = isSmallScreen ? Responsive.fontSize(context, 20) : Responsive.fontSize(context, 26); // Chữ tiêu đề
    final double buttonHeight = isSmallScreen ? Responsive.heightPercent(context, 6) : Responsive.heightPercent(context, 6); // Chiều cao nút (approx)
    final double buttonFontSize = isSmallScreen ? Responsive.fontSize(context, 11) : Responsive.fontSize(context, 13); // Size chữ trong nút

    return Container(
      margin: EdgeInsets.all(Responsive.widthPercent(context, 4)),
      padding: EdgeInsets.all(isSmallScreen ? Responsive.widthPercent(context, 4) : Responsive.widthPercent(context, 5)),
        ...
        children: [
          ...
          Text(
            ...
            style: TextStyle(
              ...
              fontSize: isSmallScreen ? Responsive.fontSize(context, 11) : Responsive.fontSize(context, 13),
              height: 1.6
            ),
          ),
  ...
  Widget _animationPulseBadge(String content) {
    return FadeTransition(
      ...
      child: Container(
        margin: EdgeInsets.only(bottom: Responsive.heightPercent(context, 1.2)),
        padding: EdgeInsets.symmetric(horizontal: Responsive.widthPercent(context, 2.5), vertical: Responsive.heightPercent(context, 0.6)),
        decoration: BoxDecoration(
