...
class OwnerHomeScreen extends ConsumerWidget {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: IndexedStack(index: selectedNavIndex, children: mainScreens),
          ),
        ],
      ),
                  ...
                  children: ['BOSS', 'OWNER', 'MANAGER'].map((role) {
                    ...
                    return GestureDetector(
                      onTap: () {
                        ...
                        final newBranches =
                            branchMapping[role] ?? branchMapping['BOSS']!;
                        final currentBranch = ref.read(selectedBranchProvider);
                        if (!newBranches.any(
                          (b) => b['value'] == currentBranch,
                        )) {
  ...
  Widget _buildBranchDropdown(
    ...
    final displayValue = hasCurrentValue
        ? selectedBranch
        : branches.first['value'];
